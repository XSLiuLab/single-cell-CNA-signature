...
sc_segment <- fread("~/project/scCNSignature/ACE_NEW/pcawg_low/result/pcawg_ACE_smooth_segment.txt",data.table = F)
...
saveRDS(divide_result,"~/project/scCNSignature/ACE_NEW/pcawg_low/result/pcawg_tumor_tally_ploidy.rds")
